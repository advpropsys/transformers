...
def _unpad_modernbert_input(
    ...
    if inputs.dim() == 2:
        # For input_ids, we need to index in a way that preserves gradients
        unpadded_inputs = inputs.flatten().index_select(0, indices)
    else:
        batch, seqlen, *rest = inputs.shape
        shape = batch * seqlen
        # For input embeddings, use index_select to maintain gradients
        unpadded_inputs = inputs.view(shape, *rest).index_select(0, indices)
